<h1>read-pkg <a href="https://travis-ci.org/sindresorhus/read-pkg"><img src="https://travis-ci.org/sindresorhus/read-pkg.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<h2>Usage</h2>
<pre><code class="language-js">var readPkg = require('read-pkg');
...
<h2>API</h2>
<h3>readPkg([path], [options])</h3>
<p>Returns a promise that resolves to the parsed JSON.</p>
<h3>readPkg.sync([path], [options])</h3>
