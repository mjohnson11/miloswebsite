<h1>normalize-package-data <a href="https://travis-ci.org/npm/normalize-package-data"><img src="https://travis-ci.org/npm/normalize-package-data.png?branch=master" alt="Build Status"></a></h1>
...
<pre><code class="language-javascript">normalizeData = require('normalize-package-data')
...
<h2>What normalization (currently) entails</h2>
<ul>
...
<h3>Rules for license field</h3>
<p>The <code>license</code> field should be a valid <em>SPDX license expression</em> or one of the special values allowed by <a href="https://npmjs.com/packages/validate-npm-package-license">validate-npm-package-license</a>. See <a href="https://docs.npmjs.com/files/package.json#license">documentation for the license field in package.json</a>.</p>
<h2>Credits</h2>
