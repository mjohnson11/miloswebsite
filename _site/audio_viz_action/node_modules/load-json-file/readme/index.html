<h1>load-json-file <a href="https://travis-ci.org/sindresorhus/load-json-file"><img src="https://travis-ci.org/sindresorhus/load-json-file.svg?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<h2>Usage</h2>
<pre><code class="language-js">const loadJsonFile = require('load-json-file');
...
<h2>API</h2>
<h3>loadJsonFile(filepath)</h3>
<p>Returns a promise that resolves to the parsed JSON.</p>
<h3>loadJsonFile.sync(filepath)</h3>
